...
function ResetPasswordForm() {
  ...
  return (
    <>
      ...
      <p className="text-sm text-center text-gray-500 mb-6">Choose a strong password for your account.</p>
          ...
          <div className="relative">
            <input type={showConfirm ? "text" : "password"} placeholder="Repeat new password"
              ...
              className={`w-full border p-3 rounded-xl pr-10 focus:ring-2 focus:outline-none text-gray-800 ${
                confirm && confirm !== password ? "border-red-300 focus:ring-red-400" : "border-gray-300 focus:ring-blue-500"
              }`} />
