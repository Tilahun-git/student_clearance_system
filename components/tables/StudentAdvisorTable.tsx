...
export default function StudentAdvisorTable({
  students, selectedStudents, onToggleStudent, onToggleAll,
}: Props) {
              ...
              {students.map((student) => {
                ...
                return (
                  <tr
                    ...
                    className={`border-b last:border-0 transition hover:bg-slate-50 ${selected ? "bg-indigo-50" : ""}`}
                  >
                    <td className="p-4">
                      <input
                        type="checkbox"
                    ...
                    <td className="p-4 text-slate-500">{student.middleName || <span className="text-slate-300">—</span>}</td>
